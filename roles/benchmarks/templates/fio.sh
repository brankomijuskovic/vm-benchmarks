...
RANDREAD1(){ fio --runtime={{ fio_runtime }} --time_based --clocksource=clock_gettime --name=randread --iodepth=128 --numjobs=8 --rw=randread --bs=4k --size={{ fio_size }} --ioengine=libaio --filename=fio.tmp --sync=0 --direct=1 --group_reporting > results-$TEST-$TIME.txt; }
RANDWRITE1(){ fio --runtime={{ fio_runtime }} --time_based --clocksource=clock_gettime --name=randwrite --iodepth=128 --numjobs=8 --rw=randwrite --bs=4k --size={{ fio_size }} --ioengine=libaio --filename=fio.tmp --sync=0 --direct=1 --group_reporting > results-$TEST-$TIME.txt; }
#libaio, sync=1
RANDREAD2(){ fio --runtime={{ fio_runtime }} --time_based --clocksource=clock_gettime --name=randread --iodepth=128 --numjobs=8 --rw=randread --bs=8k --size={{ fio_size }} --ioengine=libaio --filename=fio.tmp --sync=1 --direct=1 --group_reporting > results-$TEST-$TIME.txt; }
RANDWRITE2(){ fio --runtime={{ fio_runtime }} --time_based --clocksource=clock_gettime --name=randwrite --iodepth=128 --numjobs=8 --rw=randwrite --bs=8k --size={{ fio_size }} --ioengine=libaio --filename=fio.tmp --sync=1 --direct=1 --group_reporting > results-$TEST-$TIME.txt; }


# Sequential read/write tests, no variants needed
SEQREAD(){ fio --runtime={{ fio_runtime }} --time_based --clocksource=clock_gettime --name=read --iodepth=128 --numjobs=8 --rw=read --bs=64k --size={{ fio_size }} --ioengine=libaio --filename=fio.tmp --sync=0 --direct=1 --group_reporting > results-$TEST-$TIME.txt; }
SEQWRITE(){ fio --runtime={{ fio_runtime }} --time_based --clocksource=clock_gettime --name=write --iodepth=128 --numjobs=8 --rw=write --bs=64k --size={{ fio_size }} --ioengine=libaio --filename=fio.tmp --sync=0 --direct=1 --group_reporting > results-$TEST-$TIME.txt; }
